...
public class BookMain {
	...
	public static void main(String[] args) {
		...
		books.add(new Book(104, "Book4", "Author D", 1050, 9100));
		...
		System.out.println("Super Expensive Books");
		ArrayList<Book> bList=bookSearch.getBookAsPerBehaviour(books, new BookPredicate() {
			@Override
		...
		//Lambda Expression
		ArrayList<Book> bList1=bookSearch.getBookAsPerBehaviour(books, (book)-> {return book.getPrice()>5000; });
	}
